"use strict";
var instruct = function (n, us, them, advUs, advThem) {
    if (n === void 0) { n = 3; }
    if (us === void 0) { us = 1; }
    if (them === void 0) { them = 1; }
    if (advUs === void 0) { advUs = 0; }
    if (advThem === void 0) { advThem = 0; }
    var nData = orunderDataStandAlone.filter(function (x) {
        return x.n === n;
    });
    var actualFR = parseFloat((us / them).toPrecision(4));
    //FILTER HERE
    var diceData = nData;
...
var refresh = function (_a) {
    var n = _a.n, us = _a.us, them = _a.them, advUs = _a.advUs, advThem = _a.advThem;
